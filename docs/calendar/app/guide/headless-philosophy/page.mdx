...
See our [Examples](/examples) to see how the same `useCalendar` hook powers completely different calendar designs:
...
**Next:** Learn how to use the [API Reference](/api/use-calendar) to build your own calendar.

...
- Learn about all available options in the [API Reference](/api-docs/api/use-calendar)
- See practical examples with different styling solutions
- Build a [DatePicker](/docs/examples/date-picker) or [DateRangePicker](/docs/examples/date-range-picker)
